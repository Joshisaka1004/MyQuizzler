...
class QuestionBank {
    ...
    init() {
        ...
        // I have added one of my own questions in a extensive procedure
        let myPersonalQuestion = Question(text: "1200 / 3 = 400, right?", correctAnswer: true)
        list.append(myPersonalQuestion)
